...
public class SS {
    ...
    public static void BringToFront(IntPtr hWnd) { ShowWindow(hWnd, 9); SetForegroundWindow(hWnd); BringWindowToTop(hWnd); }
}
'@
...
$bmp.Save("C:\Users\skinix\cursach\screenshot_panel2.png")
$g.Dispose(); $bmp.Dispose()
Write-Host "PANEL_SS_OK"
